...
[winget](https://docs.microsoft.com/ko-kr/windows/package-manager/winget/)은 윈도우용 패키지 매니저로 앱 관리(검색, 설치, 업그레이드, 제거 등)가 가능하다. 앞으로 윈도우에서 프로그램을 설치 할 때 최우선 순위로 사용될 예정이다.
