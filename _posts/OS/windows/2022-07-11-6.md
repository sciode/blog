...
[winget](https://docs.microsoft.com/ko-kr/windows/package-manager/winget/)은 윈도우용 패키지 매니저로 앱 관리(검색, 설치, 업그레이드, 제거 등)가 가능하다. 앞으로 윈도우에서 프로그램을 설치 할 때 1순위로 사용될 예정이다.
...
* `winget` 관련 상세 명령어는 [공식문서](https://docs.microsoft.com/ko-kr/windows/package-manager/winget/#commands)를 참고하면 된다.
* <https://winget.run/>
여기에서 winget으로 설치 가능한 패키지를 편리하게 검색할 수 있다.
